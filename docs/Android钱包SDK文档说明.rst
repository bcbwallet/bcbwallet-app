...
方法原型：void addAccount(String account, String code, OnWalletCallback
callback);
...
void createCloudWallet(String chainType, OnWalletCallback callback);
...
void getCloudWalletList(String chainType, OnWalletCallback callback);
...
void cloudWalletTransation(String address,String chainType,String
walletCall, OnWalletCallback callback);
...
| walletCall   | String             | 是     | json串，此字段根据不同的合约定义有不同的数据格式；具体请参见《BCB钱包通用支付接入规范》总描述   |
+--------------+--------------------+--------+-------------------------------------------------------------------------------------------------+
| callback     | OnWalletCallback   | 是     | 回调接口，见附录\ `7.1 <#7.1%20OnWalletCallback>`__\ ，String为hash                             |
+--------------+--------------------+--------+-------------------------------------------------------------------------------------------------+
...
void signCloudTransation(String address,String chainType,String
walletCall, OnWalletCallback callback);
...
| walletCall   | String             | 是     | json串，此字段根据不同的合约定义有不同的数据格式；具体请参见《BCB钱包通用支付接入规范》总描述   |
+--------------+--------------------+--------+-------------------------------------------------------------------------------------------------+
| callback     | OnWalletCallback   | 是     | 回调接口，见附录\ `7.1 <#7.1%20OnWalletCallback>`__\ ，String为交易签名数据                     |
+--------------+--------------------+--------+-------------------------------------------------------------------------------------------------+
